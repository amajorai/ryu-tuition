...
- **Any agent can tutor you.** The app ships an MCP server: `tuition.due`,
  `tuition.quiz`, `tuition.grade`, `tuition.log` and `tuition.mastery`. A chat, a
...
<a href="https://github.com/amajorai/ryu-tuition/stargazers">
  <picture>
